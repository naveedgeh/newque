    ...
    <div class="container clearfix">
        ...
        <div class="row col-mb-50 mb-0">
            ...
            <div class="col-lg-4">
                ...
                <p>We are fully insured, covering your move, up to £50,000 (goods in transit) and up to £1,000,000 ( assets liability insurance).  All our vans are equipped with trolleys, blankets, straps, bungee cords, tracking, sat-nav. </p>
            </div>
            <div class="col-lg-4">
                <div class="heading-block fancy-title border-bottom-0 title-bottom-border">
        ...
        <div class="row align-items-stretch">
            ...
            <div id="mk" class="col-md-6">	<img src="{{asset('assets/images/am.jpg')}}"></div>
