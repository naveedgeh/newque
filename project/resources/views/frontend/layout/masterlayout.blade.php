...
<head>
	...
	<!-- DatePicker CSS -->
	<link rel="stylesheet" href="{{asset('assets/css/components/daterangepicker.css')}}" type="text/css" />
	<!-- Range Slider CSS -->
	...
	<link rel="stylesheet" href="{{asset('assets/demos/cleaner/css/fonts.css')}}" type="text/css" /> <!-- Cleaner Theme Font -->
	<link rel="stylesheet" href="{{asset('assets/demos/cleaner/cleaner.css')}}" type="text/css" /> <!-- Cleaner Theme Custom CSS -->
	<!-- / -->
...
<body class="stretched">
				...
				<div class="container-fluid pr-0">
					<div class="header-row">
						...
						<div id="logo" class="col col-sm-auto">
							<a href="{{url('/')}}" class="standard-logo"><img src="{{asset('assets/images/logoqueremoval.png')}}" alt="Canvas Logo"></a>
							<a href="{{url('/')}}" class="retina-logo"><img src="{{asset('assets/images/logoqueremoval.png')}}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
	...
	@section('mainbody')
		...
		<section id="slider" class="slider-element bg-color" style="height: auto; padding: 0px 0; background: url({{asset('assets/demos/movers/images/bg-2.png')}}) no-repeat center center / 100% 100%;">
			...
			<div class="container mt-4" style="z-index: 2">
				...
				<div class="row topmargin justify-content-center">
						...
						<div class="tab-content rounded-bottom shadow bg-white py-4 px-5">
							<div class="tab-pane fade show active" id="home-moving" role="tabpanel" aria-labelledby="home-moving-tab">
								...
								<div class="form-widget">
									...
									<form class="row home-moving-form position-relative mb-0" action="{{url('/book')}}" method="post" >
										@csrf
					...
					<div class="col-lg-5">
						<center>
							<img style="margin-top:-1rem !important;" src="assets/images/mllll.png" alt="Image 1" >
						</center>
             ...
             <div class="heading-block center mx-auto" style="max-width: 700px">
					...
					<div id="portfolio" class="portfolio row grid-container gutter-30">
							...
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F1.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
										</div>
						...
						<article class="portfolio-item col-md-4 col-sm-6 col-12 pf-media pf-icons">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F2.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
						...
						<article class="portfolio-item col-md-4 col-sm-6 col-12 pf-media pf-icons">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F3.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
						...
						<article class="portfolio-item col-md-4 col-sm-6 col-12 pf-media pf-icons">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F4.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
						...
						<article class="portfolio-item col-md-4 col-sm-6 col-12 pf-media pf-icons">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F5.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
							...
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F6.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
							...
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F7.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
							...
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F8.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
							...
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F9.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
						...
						<article class="portfolio-item col-md-4 col-sm-6 col-12 pf-media pf-icons">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F10.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
						...
						<article class="portfolio-item col-md-4 col-sm-6 col-12 pf-media pf-icons">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F11.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
						...
						<article class="portfolio-item col-md-4 col-sm-6 col-12 pf-media pf-icons">
							<div class="grid-inner">
								<div class="portfolio-image">
									<a href="portfolio-single.html">
										<img src="assets/images/F12.jpg" alt="Open Imagination">
									</a>
									<div class="bg-overlay">
										<div class="bg-overlay-content dark" data-hover-animate="fadeIn">
											<a href="assets/images/portfolio/full/1.jpg" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
				...
				<div class="container topmargin bottommargin-lg">
					...
					<div class="row col-mb-50 mt-3">
						...
						<div class="col-lg-4 center order-lg-last">
							<img src="assets/images/man.png" alt="Cleaner" style="color: #BD0000 !important;" width="340">
					</div>
						...
						<div class="col-lg-4 col-md-6 pb-0">
							...
							<div class="feature-box fbox-plain bottommargin">
								<div class="fbox-icon">
									<img src="assets/demos/cleaner/images/icons/cleaning-man.svg" alt="Cleaner Icon">
								</div>
							...
							<div class="feature-box fbox-plain bottommargin">
								<div class="fbox-icon">
									<img src="assets/demos/cleaner/images/icons/guarantee.svg" alt="Cleaner Icon">
								</div>
								<div class="fbox-content">
						...
						<div class="col-lg-4 col-md-6">
							...
							<div class="feature-box fbox-plain bottommargin">
								<div class="fbox-icon">
									<img src="assets/demos/cleaner/images/icons/time.svg" alt="Cleaner Icon">
								</div>
								<div class="fbox-content">
							...
							<div class="feature-box fbox-plain bottommargin">
								<div class="fbox-icon">
									<img src="assets/demos/cleaner/images/icons/price.svg" alt="Cleaner Icon">
								</div>
								<div class="fbox-content">
					...
					<div class="container">
						<div class="row justify-content-between align-items-center">
							...
							<div class="col-md-5 center">
								<img src="assets/images/reviews.png" alt="Review Image" width="400">
								<div class="row mt-5">
									<div class="col-6">
				...
				<div class="section center mb-0" style="padding: 120px 0; background-color: rgba(51,94,238,0.08);">
					<div class="container" style="max-width: 700px">
						<img src="assets/images/apply.png" alt="Apply Icon" height="200" class="mb-4">
				...
				<div class="footer-widgets-wrap">
					...
					<div class="row">
						<div class="col-6 col-lg-4">
							<img class="mb-5" src="assets/images/white.png" alt="" width="223">
	...
	<script src="{{asset('assets/js/components/daterangepicker.js')}}"></script>
	...
	<script src="{{asset('assets/mx/ms.js')}}"></script>
	 <script>
