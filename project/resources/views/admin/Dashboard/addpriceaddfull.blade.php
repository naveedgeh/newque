    ...
    <div class="container" style="margin-top:30px">
      ...
      <div class="row">
        <div class="col-md-8 offset-md-2">
            <form method="post" action="{{route('newaddpriceaddfull')}}">
                @csrf
    
               
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label"></label>
                  <input type="text" name="fullpack" class="form-control" placeholder="Full Pack Price" id="stopprice" aria-describedby="stopprice">
